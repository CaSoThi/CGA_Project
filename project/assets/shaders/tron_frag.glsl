...
void main(){
    ...
    //ambient Term
    result += shade(n, lp, v, diffCol, specularCol, shininess) * pointLightIntensity(byklePointLightCol, lpLength);
    result += shade(n, sp, v, diffCol, specularCol, shininess) * spotLightIntensity(bykleSpotLightCol, spLength, sp, bykleSpotLightDir);
